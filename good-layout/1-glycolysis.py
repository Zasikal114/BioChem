...
import os
import pandas as pd
def layout_path_way_nodes_calculated(refer):
...
if __name__ == "__main__":
    ...
    node_name_refer = "" #在这里设置参考节点的名称
    success = layout_path_way_nodes_calculated(node_name_refer)
